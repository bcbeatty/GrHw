...
1. Output 1 – sorted by gender (females before males) then by last name ascending.
2. Output 2 – sorted by birth date, ascending.
3. Output 3 – sorted by last name, descending.
